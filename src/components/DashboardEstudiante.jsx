        ...
        <Header title={title} subtitle={subtitle} user={user} onNavigate={setActiveTab}>
           <div className="relative hidden md:block group">
            ...
            <input 
              ...
              className="bg-slate-50 border-none rounded-2xl pl-12 pr-6 py-3 w-64 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-indigo-600/10 focus:w-80 transition-all placeholder:text-slate-400"
            />
          </div>
        </Header>
      ...
      <div className="mb-6 flex-1">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <span className="px-2 py-0.5 bg-indigo-50 text-indigo-600 rounded text-[10px] font-black uppercase tracking-widest">Matemáticas</span>
            {vencido ? (
        ...
        <h4 className="font-black text-slate-800 text-lg mb-2 group-hover:text-indigo-600 transition-colors uppercase tracking-tight">{drill.nombre}</h4>
