...
export const USUARIOS_INICIALES = [
  { 
    ...
    email: "sandracastro626@gmail.com", 
    usuario: "admin",
    contrasena: "Admin123*", 
    rol: "administrador",
    estado: "activo",
  ...
  { 
    ...
    email: "docente@checkicfes.com", 
    usuario: "docente",
    contrasena: "Docente123*", 
    rol: "docente",
    estado: "activo",
    institucion: "I. E. Francisco José de Caldas",
    gruposAsignados: ["11A"],
  ...
  { 
    ...
    email: "estudiante@checkicfes.com", 
    usuario: "estudiante",
    codigoEstudiante: "10001",
  ...
  { 
    ...
    tipoDocumento: "CC",
    numeroDocumento: "1085000001",
    email: "sandra@example.com", 
    telefono: "3000000000",
    institucion: "I. E. Francisco José de Caldas",
    area: "Matemáticas",
    gruposAsignados: ["11A", "11B"],
...
// Completar estudiantes adicionales
for (let i = 2; i <= 10; i++) {
  USUARIOS_INICIALES.push({
    id: `user_00${i}`,
    nombreCompleto: `Estudiante ${i}`,
    tipoDocumento: "TI",
    numeroDocumento: `108500001${i}`,
    email: `est${i}@example.com`,
    codigoEstudiante: `1000${i}`,
    grado: "11",
    grupo: i <= 5 ? "11A" : "11B",
    institucion: "I. E. Francisco José de Caldas",
    docenteAsignado: "docente_001",
